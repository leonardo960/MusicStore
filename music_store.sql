...
--
-- Host: 127.0.0.1:3306
-- Creato il: Set 16, 2018 alle 16:41
...
CREATE TABLE IF NOT EXISTS `carte_ordini` (
  ...
  `nome_carta` varchar(100) DEFAULT NULL,
  `cognome_carta` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`ordine`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dump dei dati per la tabella `carte_ordini`
--

INSERT INTO `carte_ordini` (`ordine`, `numero_carta`, `data_scadenza`, `nome_carta`, `cognome_carta`) VALUES
(2, '5555-5555-5555-5555', '2020-04-01', 'Leonardo', 'Formichetti');
...
--
-- Struttura della tabella `genere_album`
--

DROP TABLE IF EXISTS `genere_album`;
CREATE TABLE IF NOT EXISTS `genere_album` (
  `genere` varchar(30) NOT NULL,
  `album` int(11) NOT NULL,
  PRIMARY KEY (`genere`,`album`),
  KEY `album` (`album`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dump dei dati per la tabella `genere_album`
--

INSERT INTO `genere_album` (`genere`, `album`) VALUES
('Commerciale', 1),
('Pop', 1),
('Pop', 2),
('Swing', 3),
...
--
-- Struttura della tabella `genere_artisti`
--

DROP TABLE IF EXISTS `genere_artisti`;
CREATE TABLE IF NOT EXISTS `genere_artisti` (
  `genere` varchar(30) NOT NULL,
  `artista` int(11) NOT NULL,
  PRIMARY KEY (`genere`,`artista`),
  KEY `artista` (`artista`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dump dei dati per la tabella `genere_artisti`
--

INSERT INTO `genere_artisti` (`genere`, `artista`) VALUES
('Pop', 2),
('Pop', 6),
('Jazz', 7),
('Swing', 7),
...
CREATE TABLE IF NOT EXISTS `ordini` (
  ...
  KEY `fk_tipo_spedizione` (`tipo_spedizione`)
...
--
-- Struttura della tabella `tipo_spedizioni`
--

DROP TABLE IF EXISTS `tipo_spedizioni`;
CREATE TABLE IF NOT EXISTS `tipo_spedizioni` (
  `nome` varchar(200) NOT NULL,
  `prezzo` float DEFAULT NULL,
  `giorni_previsti_min` int(11) DEFAULT NULL,
  `giorni_previsti_max` int(11) DEFAULT NULL,
  PRIMARY KEY (`nome`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dump dei dati per la tabella `tipo_spedizioni`
--

INSERT INTO `tipo_spedizioni` (`nome`, `prezzo`, `giorni_previsti_min`, `giorni_previsti_max`) VALUES
('Express', 15, 1, 2),
('Standard', 10, 4, 5);
...
--
-- Limiti per la tabella `genere_album`
--
ALTER TABLE `genere_album`
  ADD CONSTRAINT `genere_album_ibfk_1` FOREIGN KEY (`genere`) REFERENCES `genere` (`genere`),
  ADD CONSTRAINT `genere_album_ibfk_2` FOREIGN KEY (`album`) REFERENCES `album` (`id_album`);

--
-- Limiti per la tabella `genere_artisti`
--
ALTER TABLE `genere_artisti`
  ADD CONSTRAINT `genere_artisti_ibfk_1` FOREIGN KEY (`genere`) REFERENCES `genere` (`genere`),
  ADD CONSTRAINT `genere_artisti_ibfk_2` FOREIGN KEY (`artista`) REFERENCES `artisti` (`id_artista`);
...
ALTER TABLE `ordini`
  ...
  ADD CONSTRAINT `fk_tipo_spedizione` FOREIGN KEY (`tipo_spedizione`) REFERENCES `tipo_spedizioni` (`nome`);
